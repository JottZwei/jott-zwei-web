...
const Reternity_ref = () => {
    return (
        <Container>
        <Wrap>
        <StaticImage src="../../images/2_Referenzen/Reternity/ref_rt_4.jpg" alt="" loading="eager" objectFit="cover" layout="fullWidth" placeholder="blurred"/>
            <Client>Reternity</Client>
            <Pills>
                E-Commerce, Flyer
            </Pills>
        </Wrap>
        ...
        <ImageList>
            <StaticImage src="../../images/2_Referenzen/Reternity/ref_rt_1.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Reternity/ref_rt_2.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Reternity/ref_rt_3.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Reternity/ref_rt_4.jpg" alt="" />
        </ImageList>
        <Cta />
        </Container>
    )
