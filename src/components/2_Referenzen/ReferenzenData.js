...
export const ReferenzenData = [
    {
        ...
        gallery: [
            <StaticImage src="../../images/2_Referenzen/Ziemer/ref_zc_1.jpg" alt="Logo für Ziemer Consult auf Visitenkartenpapier gedruckt" placeholder="blurred" objectFit="cover" />,
