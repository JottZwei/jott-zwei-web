...
const Freizeittanken_ref = () => {
    return (
        <Container>
        <Wrap>
        <StaticImage src="../../images/2_Referenzen/Freizeittanken/ref_ft_0_head.jpg" alt="" loading="eager" objectFit="cover" />
            <Client>Freizeittanken</Client>
            <Pills>
                Internetseite, Logo, Mehr
            </Pills>
        </Wrap>
        <EntryText>
        ...
        <ImageList>
            ...
            <StaticImage src="../../images/2_Referenzen/Freizeittanken/ref_ft_2.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Freizeittanken/ref_ft_3.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Freizeittanken/ref_ft_4.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Freizeittanken/ref_ft_5.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Freizeittanken/ref_ft_6.jpg" alt="" />
        </ImageList>
        <Cta />
        </Container>
    )
...
export default Freizeittanken_ref