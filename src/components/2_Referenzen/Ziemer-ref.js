...
const ziemer_ref = () => {
    return (
        <Container>
        <Wrap>
        <StaticImage src="../../images/2_Referenzen/Ziemer/ref_zc_0_head.jpg" alt="" loading="eager" objectFit="cover" />
            <Client>Ziemer Consult</Client>
            <Pills>
                Internetseite, Logo, E-Commerce, Mehr
            </Pills>
        </Wrap>
        <EntryText>
        ...
        <ImageList>
            <StaticImage src="../../images/2_Referenzen/Ziemer/ref_zc_1.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Ziemer/ref_zc_2.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Ziemer/ref_zc_3.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Ziemer/ref_zc_4.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Ziemer/ref_zc_5.jpg" alt="" />
            <StaticImage src="../../images/2_Referenzen/Ziemer/ref_zc_6.jpg" alt="" />
        </ImageList>
        <Cta />
        </Container>
    )
